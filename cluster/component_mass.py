...
if __name__ == "__main__":
    ...
    base_images_path = os.path.join("..", "output", "validation",
        "11FCMN8rmsprop_lr0.0001_prep_keras_dp0.001_ep200","prediction_masks")
    ...
    for img in img_list:
        ...
        ground_truth = (utils_cluster.read_image_grayscale(
            os.path.join('D:\\temp\\dataset_resize\\masks_resize', 'mask_'+img[3:-3]+'png')))
        ...
        if centers is not None:
            for component_label in range(num_labels):
                ...
                #relative_area
                metrics['relative_area'].append(component_area / prediction_area) 
